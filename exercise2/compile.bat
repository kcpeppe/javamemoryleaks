...
set DOMAIN=src/main/java/com/kodewerk/stock/*.java src/main/java/com/kodewerk/web/*.java src/main/java/com/kodewerk/db/*.java src/main/java/com/kodewerk/cache/*.java
set SOURCES=%DOMAIN%
